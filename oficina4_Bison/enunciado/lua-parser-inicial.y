...
stat_repeat: <<<complete o código aqui>>>
...
stat_forin: <<<complete o código aqui>>>
...
stat_last: <<<complete o código aqui>>>
...
exp_binary:
    ...
    <<<complete os demais operadores binários>>>
    ;

exp_unary:
      NOT exp { $$ = !cond_enabled() ? NULL : do_operation($1, $2, NULL); }
    <<<complete os demais operadores unários>>>
    ;
