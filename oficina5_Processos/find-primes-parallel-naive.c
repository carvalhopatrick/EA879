/* Slow prime number finder, naive parallel implementation */
...
int main(int argc, char *argv[]) {
    ...
    if (n < 0 || p <= 0) {
        fprintf(stderr, "usage: find-primes-parallel-naive <N> <P>\n"
    ...
    for (long i=0; i<p-1; i++) {
        ...
        // we are in the child branch: duplicates again, if necessary
    }
